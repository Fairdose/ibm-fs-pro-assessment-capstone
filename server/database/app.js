...
try {
    reviews_data = JSON.parse(await fs.readFile("./data/reviews.json", 'utf8')) // jshint ignore:line
    dealerships_data = JSON.parse(await fs.readFile("./data/dealerships.json", 'utf8')) // jshint ignore:line
} catch (err) {
...
// Connect to MongoDB
try {
    await mongoose.connect("mongodb://mongo_db:27017/", { // jshint ignore:line
    ...
    // Initialize data
    await Reviews.deleteMany({}) // jshint ignore:line
    await Reviews.insertMany(reviews_data.reviews) // jshint ignore:line
    console.log("Reviews initialized")

    await Dealerships.deleteMany({}) // jshint ignore:line
    await Dealerships.insertMany(dealerships_data.dealerships) // jshint ignore:line
